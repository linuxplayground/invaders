...
;===============================================================================
tms_patternTable:               equ 0x0000
tms_patternTableLen:            equ 0x800

tms_colorTable:                 equ 0x2000
tms_colorTableLen:              equ 0x800

tms_nameTable:                  equ 0x3800
tms_nameTableLen:               equ 0x300

tms_spriteAttributeTable:       equ 0x3b00
tms_spriteAttributeTableLen:    equ 0x100

tms_spritePatternTable:         equ 0x1800
tms_spritePatternTableLen:      equ 0x800
